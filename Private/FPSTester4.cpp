...
// Sets default values
AFPSTester4::AFPSTester4() : MoveSpeed(100.0f), RotationSpeed(100.0f), ScaleSpeed(100.0f), bSwitch(true), TickRate(0)
{
...
void AFPSTester4::MoveActor(bool value, float DeltaTime)
{
...
void AFPSTester4::RotationActor(bool value, float DeltaTime)
{
...
void AFPSTester4::ScaleActor(bool value, float DeltaTime)
{
...
// Called every frame
void AFPSTester4::Tick(float DeltaTime)
{
