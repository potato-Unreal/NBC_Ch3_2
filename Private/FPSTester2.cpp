...
// Sets default values
AFPSTester2::AFPSTester2() : MoveSpeed(100.0f), RotationSpeed(100.0f), ScaleSpeed(100.0f), bSwitch(true), TickRate(0)
{
...
void AFPSTester2::MoveActor(bool value, float DeltaTime)
{
...
void AFPSTester2::RotationActor(bool value, float DeltaTime)
{
...
void AFPSTester2::ScaleActor(bool value, float DeltaTime)
{
...
// Called every frame
void AFPSTester2::Tick(float DeltaTime)
{
