...
// Sets default values
AFPSTester3::AFPSTester3() : MoveSpeed(100.0f), RotationSpeed(100.0f), ScaleSpeed(100.0f), bSwitch(true), TickRate(0)
{
...
void AFPSTester3::MoveActor(bool value, float DeltaTime)
{
...
void AFPSTester3::RotationActor(bool value, float DeltaTime)
{
...
void AFPSTester3::ScaleActor(bool value, float DeltaTime)
{
...
// Called every frame
void AFPSTester3::Tick(float DeltaTime)
{
