...
// Sets default values
AFPSTester5::AFPSTester5() : MoveSpeed(100.0f), RotationSpeed(100.0f), ScaleSpeed(100.0f), bSwitch(true), TickRate(0)
{
...
void AFPSTester5::MoveActor(bool value, float DeltaTime)
{
...
void AFPSTester5::RotationActor(bool value, float DeltaTime)
{
...
void AFPSTester5::ScaleActor(bool value, float DeltaTime)
{
...
// Called every frame
void AFPSTester5::Tick(float DeltaTime)
{
